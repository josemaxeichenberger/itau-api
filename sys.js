...
function buscar() {
	...
	function atualizaAntecipacao() {
		...
		if (antecipadas > 0) {
			const valorAntecipacao = valorOriginal-(valorJuros + valorTaxas); // Sem conversões desnecessárias

// Para formatar para duas casas decimais
const valorAntecipacaoFormatado = moneyFormat.format(
  Math.round(valorAntecipacao * 100) / 100
);
			...
			<td>
				...
				<span class="text-dark fw-bolder d-block fs-5">${valorAntecipacaoFormatado}*</span>
			</td>
