...
class instalacoes extends ConexaoMysqlAncora
{
    ...
    public $cep_ancora;
    public $rua_ancora;
    public $bairro_ancora;
    public $cidade_ancora;
    public $estado_ancora;
    public $numero_ancora;
    public $complemento_ancora;
    ...
    public function getCep_ancora()
    {
        return $this->cep_ancora;
    }
    public function getRua_ancora()
    {
        return $this->rua_ancora;
    }
    public function getBairro_ancora()
    {
        return $this->bairro_ancora;
    }
    public function getCidade_ancora()
    {
        return $this->cidade_ancora;
    }
    public function getEstado_ancora()
    {
        return $this->estado_ancora;
    }
    public function getNumero_ancora()
    {
        return $this->numero_ancora;
    }
    public function getComplemento_ancora()
    {
        return $this->complemento_ancora;
    }
    ...
    public function setCep_ancora($cep_ancora)
    {
        $this->cep_ancora = $cep_ancora;
    }
    public function setRua_ancora($rua_ancora)
    {
        $this->rua_ancora = $rua_ancora;
    }
    public function setBairro_ancora($bairro_ancora)
    {
        $this->bairro_ancora = $bairro_ancora;
    }
    public function setCidade_ancora($cidade_ancora)
    {
        $this->cidade_ancora = $cidade_ancora;
    }
    public function setEstado_ancora($estado_ancora)
    {
        $this->estado_ancora = $estado_ancora;
    }
    public function setNumero_ancora($numero_ancora)
    {
        $this->numero_ancora = $numero_ancora;
    }
    public function setComplemento_ancora($complemento_ancora)
    {
        $this->complemento_ancora = $complemento_ancora;
    }
