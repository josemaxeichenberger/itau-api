				...
				<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
					...
					<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="col-lg-6 col-xxl-6">
								...
								<div class="card h-100">
									...
									<div class="card-body p-9">
										...
										$conta_opera = $conta_opera->CountCnpj();
										...
										<div class="d-flex flex-wrap">
											...
											<div class="d-flex flex-column justify-content-center flex-row-fluid pe-11 mb-5">
												...
												<div class="d-flex fs-6 fw-bold align-items-center mb-3">
													...
													<?php
													$duplicatas = new antecipadas();
													$duplicatas->setFornecedor($_SESSION["id"]);
													$duplicatas = $duplicatas->totaldupliByFornecedor();
													?>
							...
							<div class="col-lg-6 col-xxl-6">
								...
								<div class="card h-100">
									<div class="card-body p-9">
										...
										if (is_null($totaloperado['valor'])) {
											$totaloperado['valor'] = 0;
										}
										?>
										<div class="fs-2hx fw-bolder">R$ <?php if (!is_null($totaloperado['valor'])) {
										...
										<div class="fs-6 d-flex justify-content-between mb-4">
											...
											<div class="d-flex fw-bolder">
												...
												<!--end::Svg Icon-->R$ <?php if (!is_null($totaloperado2['valor'])) {
																			echo number_format($totaloperado2['valor'], 2, ',', '.');
																		} else {
																			echo '0,00';
																		} ?> 
											</div>
										...
										<div class="fs-6 d-flex justify-content-between my-4">
											...
											<?php
											$totaloperado3 = new antecipadas();
											$totaloperado3->setFornecedor($_SESSION["id"]);
											$totaloperado3 = $totaloperado3->Sum_descontoTaxasFornecedor();
											...
											<div class="d-flex fw-bolder">
												...
												<!--end::Svg Icon-->R$ <?php if (!is_null($totaloperado3['valor'])) {
																			echo number_format($totaloperado3['valor'], 2, ',', '.');
																		} else {
																			echo '0,00';
																		} ?>
											</div>
										...
										<div class="fs-6 d-flex justify-content-between mt-4">
											...
											<?php
											$totaloperado4 = new antecipadas();
											$totaloperado4->setFornecedor($_SESSION["id"]);
											$totaloperado4 = $totaloperado4->Sum_jurosTaxasFornecedor();
											?>
											<div class="d-flex fw-bolder">
												<!--begin::Svg Icon | path: icons/duotune/arrows/arr007.svg-->
												<span class="svg-icon svg-icon-3 me-1 svg-icon-success">
												...
												<!--end::Svg Icon-->R$ <?php if (!is_null($totaloperado4['valor'])) {
																			echo number_format($totaloperado4['valor'], 2, ',', '.');
																		} else {
																			echo '0,00';
																		} ?>
											</div>
						...
						<div class="row g-6 g-xl-9">
							...
							$antecipadas->setFornecedor($_SESSION["id"]);
							$antecipadas = $antecipadas->AntecipadasFornecedor();
							foreach ($antecipadas as $row) {
								$quantidade = new antecipadas();
								$quantidade->setFornecedor($_SESSION["id"]);
								$quantidade->setId($row['id']);
								$quantidade = $quantidade->totaldupli();
								$status = new antecipadas();
								$status->setFornecedor($_SESSION["id"]);
								$status->setId($row['id']);
								$status = $status->antecipadasDetalhes();
