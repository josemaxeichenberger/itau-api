...
<body id="kt_body" style="background-image: url('../assets/media/misc/page-bg-dark.jpg')" class="dark-mode page-bg header-fixed header-tablet-and-mobile-fixed aside-enabled">
                                    ...
                                    <div class="card mb-5 mb-xl-8">
                                        <div class="card-header border-0 pt-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder fs-3 mb-1">Relatório de Execução Api</span>
                                                ...
                                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="kt_datatable_example_1">
                                                    ...
                                                    <thead>
                                                        <tr class="fw-bolder text-muted">
                                                            ...
                                                            <th class="" style="max-width: 200px;">Curl</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $acessos = new execucaoCron();
                                                        $res = $acessos->SelectAll();
                                                        foreach ($res as $row) {
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"><?php echo date('d/m/Y H:i:s', strtotime($row['data'])); ?></a>
                                                                </td>
    ...
    <script>
        ...
        var KTDatatablesButtons = function() {
            ...
            // Hook export buttons
            var exportButtons = () => {
                const documentTitle = 'Relatório de Execução Api';
                var buttons = new $.fn.dataTable.Buttons(table, {
                    buttons: [{
                        ...
                        },
                        {
                            ...
                            pageSize: 'A4', // Common page sizes: A4, A3, letter, legal, etc.
                            customize: function(doc) {
                                // Column width
                                doc.content.forEach(function(item) {
                                    if (item.table) {
                                        item.table.widths = [50, 100, 300, 50, '*', '*']
                                    }
                                });
                            }
                        }
