...
require_once('../Class/ancora.class.php');
...
function getNomeEstadoPorSigla($sigla) {
  // Array associativo com as siglas dos estados brasileiros e seus respectivos nomes completos
  $estados = [
      'AC' => 'Acre',
      'AL' => 'Alagoas',
      'AP' => 'Amapá',
  ...
  // Verifica se a sigla está presente no array
...
$html = '
  ...
  <p>
    <span class="under">CESSIONÁRIO:</span> '.$ANCORA['razao'].', pessoa jurídica de direito privado, devidamente inscrita perante o CNPJ/MF sob o nº '.$ANCORA['cnpj'].', com sede na '.$ANCORA['rua'].', '.$ANCORA['numero'].', '.$ANCORA['bairro'].', '.$ANCORA['cidade'].',
     Estado de '. getNomeEstadoPorSigla($ANCORA['estado']).', CEP '.$ANCORA['cep'].'
     <br><span class="bold">Representante Legal:</span> '.$ANCORA['nome_representante'].'
    <br><span class="bold">RG</span> nº '.$ANCORA['rg'].'
    <br><span class="bold">CPF/MF</span> nº '.$ANCORA['cpf'].'
    <br><span class="bold">Estado Civil:</span> '.$ANCORA['estado_civil'].'
    <br><span class="bold">Nacionalidade:</span> '.$ANCORA['nacionalidade'].'
    <br><span class="bold">Profissão:</span> '.$ANCORA['profissao'].'
    <br><span class="bold">Endereço:</span> '.$ANCORA['rua'].', '.$ANCORA['numero'].', '.$ANCORA['bairro'].', '.$ANCORA['cidade'].'/'.$ANCORA['estado'].', CEP '.$ANCORA['cep'].'.
    <br><span class="bold">Telefone:</span>'.$ANCORA['telefone'].'
    <br><span class="bold">e-mail:</span> '.$ANCORA['email_resgiter'].'
  ...
  <p>
    (ii) Para o CESSIONÁRIO - '.$ANCORA['razao'].' - CNPJ/MF sob o nº '.$ANCORA['cnpj'].' na pessoa de seu representante legal, '.$ANCORA['nome_representante'].'
    <br>b.1) e-mail: '.$ANCORA['email_resgiter'].'
    <br>b.2) fone móvel: '.$ANCORA['telefone'].'
  </p>
  <p>
  ...
  <br>'.$ANCORA['razao'].'
  <br>CNPJ/MF sob o nº '.$ANCORA['cnpj'].'
  </span>
</p>
