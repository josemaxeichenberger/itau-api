                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="fornecedor.php?id=<?php echo $row['id_user']; ?>" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"><?php echo $ANCORA['razao'] ?></a>
