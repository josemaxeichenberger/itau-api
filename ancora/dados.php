...
if($busca_fornnecedores["representante"]){
		...
		<div class="row">
			<div class="col-md-6 col-6">
				<div class="form-group d-flex flex-column mb-8 fv-row">
					...
					<input type="text" class="form-control form-control-solid money2"  name="limite" id="limite" value="<?php echo $busca_fornnecedores["limite"]; ?>">
				</div>
			</div>
			<div class="col-md-6 col-6">
				<div class="form-group d-flex flex-column mb-8 fv-row">
					<label class="fs-6 fw-bold mb-2" for="titulo">Taxa de Juros (%):</label>
					<input type="text" class="form-control form-control-solid money2" name="juros" id="juros" value="<?php echo $busca_fornnecedores["juros"]; ?>">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="form-group d-flex flex-column mb-8 fv-row">
					...
					<input type="text" step="any" class="form-control form-control-solid money2" name="boleto" id="boleto" value="<?php echo $busca_fornnecedores["boleto"]; ?>">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group d-flex flex-column mb-8 fv-row">
					<label class="fs-6 fw-bold mb-2" for="valor">TAC (R$):</label>
					<input type="text" step="any" class="form-control form-control-solid money2" name="tac" id="tac" value="<?php echo $busca_fornnecedores["tac"]; ?>">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group d-flex flex-column mb-8 fv-row">
					<label class="fs-6 fw-bold mb-2" for="valor">TED (R$):</label>
					<input type="text" step="any" class="form-control form-control-solid money2" name="ted" id="ted" value="<?php echo $busca_fornnecedores["ted"]; ?>">
				</div>
			</div>
		</div>
